...
from bugbo_functions import before_media_send
from get_images import get_images

config: Dict[str, Any] = {
    "bot_description": "Bugbo - A SciOly Discord Bot for Insect ID",  # short bot description
    "bot_signature": "Bugbo - An Entomology ID Bot",  # signature for embeds
    "prefixes": ["e.", "E."],  # bot prefixes, primary prefix is first in list
    "id_type": "insects",  # stars, fossils, muscles, etc. - plural noun
    ...
    "source_link": "https://github.com/tctree333/Bugbo",  # link to source code (may be hosted on github)
    "name": "bugbo",  # all lowercase, no spaces, doesn't really matter what this is
    ...
    "short_id_type": "e",  # short (usually 1 letter) form of id_type, used as alias for the pic command
    "invite": "https://discord.com/oauth2/authorize?client_id=1252793513700233339&permissions=51200&scope=bot",  # bot server invite link
    ...
    "category_aliases": {  # aliases for categories
        ...
        "phasmida": ["stick insects", "phasmatodea", "phasmatoptera"],
    ...
    "custom_extensions": ["bugbo_ext"],  # custom bot extensions to enable
